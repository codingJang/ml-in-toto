...
def main():
  ...
  distribute.add_material_rule_from_string("ALLOW mnist-dist/src/run_app.sh")
  distribute.add_material_rule_from_string("ALLOW mnist-dist/src/build_dist.sh")
  distribute.add_material_rule_from_string("ALLOW mnist-dist/src/download_mnist.sh")
  ...
  distribute.add_product_rule_from_string("ALLOW mnist-dist/src/run_app.sh")
  distribute.add_product_rule_from_string("ALLOW mnist-dist/src/build_dist.sh")
  distribute.add_product_rule_from_string("ALLOW mnist-dist/src/download_mnist.sh")
  ...
  inspection.set_run_from_string("bash download_mnist.sh")
  inspection.add_material_rule_from_string("MATCH dist/* WITH PRODUCTS IN mnist-dist/ FROM distribute")
  inspection.add_material_rule_from_string("MATCH data/* WITH PRODUCTS IN mnist-prep/ FROM make-dataset")
  inspection.add_material_rule_from_string("MATCH models/mnist_cnn.pt WITH PRODUCTS IN mnist-train/ FROM train-model")
  inspection.add_material_rule_from_string("MATCH run_app.sh with PRODUCTS IN mnist-dist/src/ FROM distribute")
  inspection.add_material_rule_from_string("MATCH download_mnist.sh with PRODUCTS IN mnist-dist/src/ FROM distribute")
  ...
  inspection.add_product_rule_from_string("MATCH run_app.sh with PRODUCTS IN mnist-dist/src/ FROM distribute")
  inspection.add_product_rule_from_string("MATCH download_mnist.sh with PRODUCTS IN mnist-dist/src/ FROM distribute")
