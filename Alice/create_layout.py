...
def main():
  ...
  make_dataset.add_product_rule_from_string(f"ALLOW mnist-prep/data/*")
  ...
  inspection = Inspection(name="pre-execution")
  inspection.set_run_from_string("mkdir some_directory/")
